                ...
                <div class="col-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                           ...
                           <input type="hidden" id="material_id" name="material_id" class="form-control form-control-lg" value="<?php echo $result['exam_id'];?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.16.0/jquery.validate.min.js"></script>
 <script src="<?=base_url('js/payment_mock.js')?>"></script>
