...
<head>
	...
	<link type="text/css" rel="stylesheet" href="<?=base_url('assets/cl/calculator/css/calclayout.css')?>"  />	 
	<script type="text/javascript" src="<?=base_url('assets/cl/calculator/js/jquery-1.8.0.min.js')?>"></script>
	<script type="text/javascript" src="<?=base_url('assets/cl/calculator/js/oscZenoedited.js')?>" ></script>           
	<script type="text/javascript" src="<?=base_url('assets/cl/calculator/js/jquery-ui.min.js')?>"></script>
	<meta http-equiv="X-UA-Compatible" content="IE=8" />
	
	<style type="text/css">
	.degree_radian [type="radio"]:checked, .degree_radian [type="radio"]:not(:checked) {
