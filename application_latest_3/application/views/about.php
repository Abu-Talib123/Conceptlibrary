...
<div class="container pt-5 mb-5">
    <div class="row">
        ...
        <div class="col-lg-4">
            <p>Nam veniam tempore tenetur aliquam architecto, hic alias quia quisquam, obcaecati laborum dolores. Ex libero cumque veritatis numquam placeat?</p>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-6 mb-lg-0 mb-4">
                <img src="<?=base_url('assets/cl/images/course_4.jpg')?>" alt="Image" class="img-fluid">
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 order-1 order-lg-2 mb-4 mb-lg-0">
                <img src="<?=base_url('assets/cl/images/course_5.jpg')?>" alt="Image" class="img-fluid">
            </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
                ...
                <div class="feature-1 border person text-center">
                    <img src="<?=base_url('assets/cl/images/person_1.jpg')?>" alt="Image" class="img-fluid">
            ...
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
                <div class="feature-1 border person text-center">
                    <img src="<?=base_url('assets/cl/images/person_2.jpg')?>" alt="Image" class="img-fluid">
                    <div class="feature-1-content">
            ...
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
                <div class="feature-1 border person text-center">
                    <img src="<?=base_url('assets/cl/images/person_3.jpg')?>" alt="Image" class="img-fluid">
                    <div class="feature-1-content">
                        <h2>Jonas Tabble</h2>
                        <span class="position mb-3 d-block">Math Teacher</span>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit morbi hendrerit elit</p>
            ...
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
                ...
                <div class="feature-1 border person text-center">
                    <img src="<?=base_url('assets/cl/images/person_4.jpg')?>" alt="Image" class="img-fluid">
                    <div class="feature-1-content">
                        <h2>Craig Daniel</h2>
                        <span class="position mb-3 d-block">Math Teacher</span>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit morbi hendrerit elit</p>
