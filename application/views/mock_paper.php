        ...
        <div class="row">
         ...
         <?php
          ...
          {?>
            ...
            <div class="col-lg-3 my-3" onclick="window.location='<?php echo base_url();?>mockpaper/course/<?= $category['category_id']; ?>'" style="cursor:pointer;">

                <div class="feature-1 category1 text-center ">

                    <div class="icon-wrapper bg-primary d-flex justify-content-center align-items-center">
