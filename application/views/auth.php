...
<div class="site-section">
   <div class="container">
      <div class="row">
        <div class="col-lg-6">
          ...
          <form action="#" method="post" id="login_Form" name="login_Form">
            <div class="row ">
                ...
                <input type="hidden" id="material_id" name="material_id"  value="<?=$material_id;?>" class="form-control form-control-lg">
        ...
        <form action="#" method="post" id="register_Form" name="register_Form" enctype="multipart/form-data">
        <div class="row justify-content-center">
            ...
            <input type="text" id="inputMobile" name="inputMobile" class="form-control form-control-lg">
            </div>
            <div class="col-md-12 form-group">
            ...
            <input type="password" id="input_confirmPassword" name="input_confirmPassword" class="form-control form-control-lg">
            </div>
            <input type="hidden" id="material_id" name="material_id"  value="<?=$material_id;?>" class="form-control form-control-lg">
