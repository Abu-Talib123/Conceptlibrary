        ...
        foreach ($student_data as $row) {
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" name="frmupdate" id="frmupdate"
                action="<?php echo base_url(); ?>admin/student/update_student_data" method="post"
                      ...
                      <div class="row">
                        <div class="col-2">
                           <div class="profile_image position-relative ">
                              <label for="inputEmail3" class="col-form-label position-absolute bg-dark  text-center p-1" style = "width:150px; bottom:0; opacity : 0.7;">Upload Profile</label>
                              <?php if ($row['student_photo']): ?>
                                  <div class = 'w-100'>
                                    <img width="150" height="150" align="absmiddle" id="uploadImage" class="profile-img"
                                        src="<?= $row['student_photo'] ?>" style="cursor:pointer;" />
                      ...
                      <select class="form-control" name="university" id="university" onchange="getcollege();">
                        ...
                        if (isset($fetch_universitydata) && $fetch_universitydata != '') {
                          ...
                          foreach ($fetch_universitydata as $data) {
                            ?>
                            <option <?php if ($data['university_id'] == $row['university_id']) {
                              echo 'selected="selected"';
                            } ?>
                              value="<?php echo $data['university_id'] ?>"><?php echo $data['university_name'] ?> </option>
                            <?php
                            $i++;
                          }
                        }
                        ...
                        <select class="form-control" name="college" id="college">
                          ...
                          if (isset($fetch_collegedata) && $fetch_collegedata != '') {
                            ...
                            foreach ($fetch_collegedata as $data) {
                              ?>
                              <option <?php if ($data['college_id'] == $row['college_id']) {
                                echo 'selected="selected"';
                              } ?>
                                value="<?php echo $data['college_id'] ?>"><?php echo $data['college_name'] ?> </option>
                              <?php
                              $i++;
                            }
                          }
                      ...
                      <select class="form-control" name="category" id="category" onchange="getsubcategory();">
                        ...
                        if (isset($fetch_categorydata) && $fetch_categorydata != '') {
                          ...
                          foreach ($fetch_categorydata as $data) {
                            ?>
                            <option <?php if ($data['category_id'] == $row['category_id']) {
                              echo 'selected="selected"';
                            } ?>
                        ...
                        <select class="form-control" name="subcategory" id="subcategory">
                          ...
                          if (isset($fetch_subcategorydata) && $fetch_subcategorydata != '') {
                            ...
                            foreach ($fetch_subcategorydata as $data) {
                              ?>
                              <option <?php if ($data['subcategory_id'] == $row['subcategory_id']) {
                                echo 'selected="selected"';
                              } ?> value="<?php echo $data['subcategory_id'] ?>"><?php echo $data['subcategory_name'] ?>
                              </option>
                              <?php
                              $i++;
                            }
                      ...
                      <select class="form-control" name="country" id="country" onchange="getstate();">
                        ...
                        if (isset($fetch_countrydata) && $fetch_countrydata != '') {
                          ...
                          foreach ($fetch_countrydata as $data) {
                            ?>
                            <option <?php if ($data['country_id'] == $row['country_id']) {
                              echo 'selected="selected"';
                            } ?>
                              value="<?php echo $data['country_id'] ?>"><?php echo $data['country_name'] ?> </option>
                            <?php
                            $i++;
                          }
                        }
                        ...
                        <select class="form-control" name="state" id="state" onchange="getcity();">
                          ...
                          if (isset($fetch_statedata) && $fetch_statedata != '') {
                            ...
                            foreach ($fetch_statedata as $data) {
                              ?>
                              <option <?php if ($data['state_id'] == $row['state_id']) {
                                echo 'selected="selected"';
                              } ?>
                        ...
                        <select class="form-control form-control-lg" name="city" id="city">
                          ...
                          if (isset($fetch_citydata) && $fetch_citydata != '') {
                            ...
                            foreach ($fetch_citydata as $data) {
                              ?>
                              <option <?php if ($data['city_id'] == $row['city_id']) {
                                echo 'selected="selected"';
                              } ?>
                                value="<?php echo $data['city_id'] ?>"><?php echo $data['city_name'] ?> </option>
                              <?php
                              $i++;
                            }
                          }
