...
<div class="site-section">
    <div class="container">
        <div id="ajax_error" class="ajax_error" style="text-align:center;">
        </div>
        ...
        <div id="before_otp">
        <form action="#" method="post" id="otpverify_Form" name="otpverify_Form">
            <div class="row justify-content-center">
                <div class="col-md-5">
                  <div class="row">
                        <div class="col-md-12 form-group">
                           <p> Welcome, <?php echo ucfirst($this->session->userdata('STUDENT_USERNAME')); ?></p>
                            <p>Kindly Check Mail For OTP Verification</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" id="inputotp"  name="inputotp" class="form-control form-control-lg">
                            <input type="hidden" id="student_id"  name="student_id"  value="<?=$this->session->userdata('STUDENT_ID')?>" class="form-control form-control-lg">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
